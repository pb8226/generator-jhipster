...
# Every AWS accout has slightly different availability zones in each region. For <%= dasherizedBaseName %>, one account might have
...
resource "aws_launch_configuration" "<%= dasherizedBaseName %>" {
...
resource "aws_security_group" "instance" {
    name = "terraform-<%= dasherizedBaseName %>-instance"
...
resource "aws_elb" "<%= dasherizedBaseName %>" {
    name = "terraform-asg-<%= dasherizedBaseName %>"
...
resource "aws_security_group" "elb" {
    name = "terraform-<%= dasherizedBaseName %>-elb"
